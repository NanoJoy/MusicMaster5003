...
public class FastFourierTransform {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < N; i++) {
            re[i] = Math.cos(16 * Math.PI * ((double)i) / N);
            im[i] = 0;
        }
        beforeAfter(fft, re, im);
    ...
    protected static void beforeAfter(FastFourierTransform fft, double[] re, double[] im) {
        System.out.println("Before: ");
        printReIm(re, im);
        double[] result = fft.fft(re, im);
        double[] fre = new double[re.length];
        double[] fim = new double [re.length];
    ...
    protected static void printReIm(double[] re, double[] im) {
        ...
        System.out.print("]\nAmp: [");
        for (int i = 0; i < re.length; i++) {
            double amp = Math.pow(re[i], 2) + Math.pow(im[i], 2);
            System.out.print(((int) (amp * 1000) / 1000.0) + " ");
        }
        System.out.println("]");
    }
}